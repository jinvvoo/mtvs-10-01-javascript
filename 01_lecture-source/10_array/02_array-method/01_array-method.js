...
chineseFood.push('양장피');            // chineseFood.push('탕수육', '양장피');
...
chickenList.unshift('마늘치킨');        // chickenList.unshift('간장치킨', '마늘치킨');
...
const idol3 = ['블랙핑크', '레드벨벳'];     // 배열명.concat(배열명1, 배열명2, ...)
...
const front = ['HTML', 'CSS', 'JavaScript', 'jQuery'];// slice(시작인덱스, 종료인덱스)
...
console.log(`snackList : ${snackList}`);       // 사탕,초콜렛,껌,과자
